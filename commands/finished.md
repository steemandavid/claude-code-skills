---
description: End-of-session workflow. Updates documentation, writes a changelog, syncs skills to GitHub, then commits/pushes project changes (only for existing project repos with uncommitted changes).
...
### Step 4: Check for Project Repository
...
### Step 5: Git & GitHub (Only for Existing Project Repos)
